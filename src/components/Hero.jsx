...
const Hero = () => {
    return (
        <section className="relative overflow-hidden bg-dark pt-24 md:pt-32 lg:pt-40 pb-20 md:pb-28">
            ...
            />
            <motion.div
                className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary rounded-full blur-3xl opacity-15"
                animate={{
                    scale: [1, 1.3, 1],
            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="flex flex-col items-center space-y-6 text-center max-w-4xl mx-auto">
                    ...
                    <motion.h1
                        className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl font-heading"
